...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 20 Kas 2022, 14:52:31
...
--
-- Tablo için tablo yapısı `nesse_ilceler`
--

CREATE TABLE `nesse_ilceler` (
  `id` int(11) NOT NULL,
...
--
-- Tablo döküm verisi `nesse_ilceler`
--

INSERT INTO `nesse_ilceler` (`id`, `ilceadi`, `sehirid`) VALUES
(1, 'ALADAĞ', 1),
(2, 'CEYHAN', 1),
(3, 'ÇUKUROVA', 1),
(4, 'FEKE', 1),
...
--
-- Tablo için indeksler `nesse_ilceler`
--
ALTER TABLE `nesse_ilceler`
  ADD PRIMARY KEY (`id`);
...
--
-- Tablo için AUTO_INCREMENT değeri `nesse_ilceler`
--
ALTER TABLE `nesse_ilceler`
